//TODO: Напиши стрілочну функцію getTotalBalanceByGender(users, gender), яка прийматиме два параметра:
...
getTotalBalanceByGender = (users, gender) => users.filter(person => person.gender === gender).reduce((acc, el, indx, arr) => acc += el.balance, 0);
